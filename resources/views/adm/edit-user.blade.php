      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 d-flex align-items-center justify-content-center">
            <div class="col-lg-10 info-item d-flex align-items-center justify-content-center">
                ...
                <form class="col-xl-10" method="POST" action="{{ url('user/'.$txtid) }}">
                  @csrf
                  @method('PUT')
                    ...
                    <div class="md-4" style="margin-top: 2rem">
                        ...
                        <input type="text" class="form-control" id="username" name="txtusername" value="{{$txtusername}}">
                    </div>
                    <div class="md-4" style="margin-top: 1rem">
                        <label for="password" class="form-label">Password</label>
                        <input type="text" class="form-control" id="password" name="txtpassword" value="{{$txtpassword}}">
                    </div>
