  ...
  <header id="header" class="header d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="/adm-index" class="active">Users</a></li>
        ...
        <div class="row gy-4">
          <div class="col-lg-14">
                ...
                <div style="margin-bottom: 1rem">
                  <a href="{{ route('user.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Tambah</a>  
                </div>
                        ...
                        <tbody>
                          @foreach ($data as $d)
                            <tr> 
                                ...
                                <td>{{$d->updated_at}}</td>
                                <td>
                                  <form class="py-1" method="POST" action="{{ url('user/'.$d->id) }}">
                                    @csrf
                                    @method('DELETE')
                                  <button type="submit" class="btn btn-sm btn-danger"><i class="fa-solid fa-trash"></i></a></button>
                                  </form> <a href="{{ url('user/'.$d->id) }}" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a><span>
                                </td>
                            </tr>
                          @endforeach
                        </tbody>
